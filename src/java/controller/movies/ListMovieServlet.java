 ...
 */
@WebServlet(name="ListMovieServlet", urlPatterns={"/movies"})
public class ListMovieServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Tên "listMovies" phải khớp với <c:forEach items="${listMovies}">
        request.setAttribute("listMovies", movieList);
        
        // 4. Chuyển tiếp đến file JSP hiển thị danh sách
        // (Sửa "adminMovies.jsp" nếu file của bạn tên khác)
